# AttentivePress, based on FoundationPress
...
### Script Folder Strucutre
  ...
  * Please note that you must run `grunt build` in your terminal for the scripts in the custom folder to be concatenated into app.js. See [Gruntfile.js](https://github.com/olefredrik/FoundationPress/blob/master/Gruntfile.js) for details
